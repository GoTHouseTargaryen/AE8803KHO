...
0.0022 over the campaign.
These figures reflect a spacecraft of length
5\,km with
NEP propulsion and a
Fission power system, optimized
...
\midrule
Total launches        & 36 \\
\quad Cargo flights   & 32 \\
\quad Crew rotations  & 4 \\
Mission duration      & 108 periods
                        (25.2 months) \\
Total program cost    & \$34160\,M \\
Cost per module       & \$589\,M \\
Modules completed     & 58 \\
Cumulative risk       & 0.0022 \\
Spacecraft length     & 5\,km \\
Propulsion            & NEP \\
Power system          & Fission \\
Cargo vehicles used &
...
The total program cost of \$34160\,M
is the sum of all bars in both panels.
Of the 36~total launches,
32~were cargo flights and 4~were
...
completed in 108~periods, giving an
...
(Currently Available Vehicles Minimizing Number of Launches)
produced 36~launches,
108~periods of assembly
(25.2~months), and
\$34160\,M of total
...
The 36-launch campaign includes
32~cargo
flights
and 4~crew
rotations,
...
0.54~modules per period
(2.30~per calendar month) was
...
0.0022 was accumulated
over 108~periods according to
Eq.~(\ref{eq:risk}).
