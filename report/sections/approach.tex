...
\noindent Vehicles are classified by status:
operational vehicles have $\tau_v = 4$--26 periods
(1--6 months); near-term vehicles
$\tau_v = 13$--18 periods (3--4 months); and vehicles
in development $\tau_v = 78$ periods ($\sim$18 months).
